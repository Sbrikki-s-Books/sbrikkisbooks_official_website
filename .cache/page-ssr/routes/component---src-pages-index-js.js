...
;// CONCATENATED MODULE: ./src/assets/readingSbrikki.gif
/* harmony default export */ const readingSbrikki = (__webpack_require__.p + "static/readingSbrikki-8a8c4a623c48c5ae31beeec7dcedbc72.gif");
;// CONCATENATED MODULE: ./src/atoms/bookAnimation/bookAnimation.module.scss
// Exports
var gif = "bookAnimation-module--gif--HkGaS";
var fadeInAndPop = "bookAnimation-module--fadeInAndPop---At6D";

;// CONCATENATED MODULE: ./src/atoms/bookAnimation/bookAnimation.jsx
function BookAnimation(){return/*#__PURE__*/index_js_default().createElement("img",{src:readingSbrikki,alt:"Sbrikki's Books Reading...",className:gif});}/* harmony default export */ const bookAnimation = (BookAnimation);
// EXTERNAL MODULE: ./node_modules/typewriter-effect/dist/react.js
var react = __webpack_require__(5459);
var react_default = /*#__PURE__*/__webpack_require__.n(react);
;// CONCATENATED MODULE: ./src/atoms/type/type.jsx
const Type=()=>{return/*#__PURE__*/index_js_default().createElement((react_default()),{options:{strings:['We read...','We drink...','We do stuff...','We have fun!'],autoStart:true,loop:true,deleteSpeed:50}});};/* harmony default export */ const type = (Type);
;// CONCATENATED MODULE: ./src/atoms/text/text.module.scss
// Exports
var text_module_text = "text-module--text--76iLQ";
var pop = "text-module--pop---AdcR";

;// CONCATENATED MODULE: ./src/atoms/text/text.jsx
const title="Welcome to Sbrikki's Books";const subtitle="Join us in this Book Club for nights full of reading";const Text=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:text_module_text},/*#__PURE__*/index_js_default().createElement("h2",null,title),/*#__PURE__*/index_js_default().createElement("h3",null,subtitle),/*#__PURE__*/index_js_default().createElement("h3",null,/*#__PURE__*/index_js_default().createElement(type,null)));};/* harmony default export */ const text_text = (Text);
;// CONCATENATED MODULE: ./src/components/hero/hero.module.scss
// Exports
var hero = "hero-module--hero--6D8n+";

;// CONCATENATED MODULE: ./src/components/hero/hero.jsx
const Hero=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:hero,id:"/"},/*#__PURE__*/index_js_default().createElement(text_text,null),/*#__PURE__*/index_js_default().createElement(bookAnimation,null));};/* harmony default export */ const hero_hero = (Hero);
// EXTERNAL MODULE: ./src/atoms/separator/separator.jsx + 1 modules
var separator = __webpack_require__(245);
// EXTERNAL MODULE: ./src/pages/404.jsx + 2 modules
var _404 = __webpack_require__(2726);
;// CONCATENATED MODULE: ./src/atoms/bookClub/bookClub.module.scss
// Exports
...
;// CONCATENATED MODULE: ./src/atoms/bookClub/bookClub.jsx
function BookClub(){return/*#__PURE__*/index_js_default().createElement("div",{className:wrap},/*#__PURE__*/index_js_default().createElement("div",{className:sbrikki},/*#__PURE__*/index_js_default().createElement("div",null),/*#__PURE__*/index_js_default().createElement("p",null,"Sbrikki's Books is "),/*#__PURE__*/index_js_default().createElement("div",null)),/*#__PURE__*/index_js_default().createElement("div",{className:container},/*#__PURE__*/index_js_default().createElement("div",{className:word},"Funny"),/*#__PURE__*/index_js_default().createElement("div",{className:word},"Awesome"),/*#__PURE__*/index_js_default().createElement("div",{className:word},"Stunning"),/*#__PURE__*/index_js_default().createElement("div",{className:word},"Crunchy")));}/* harmony default export */ const bookClub = (BookClub);
// EXTERNAL MODULE: ./src/components/layout/layout.jsx + 18 modules
var layout = __webpack_require__(4421);
// EXTERNAL MODULE: ./src/components/seo/seo.jsx
var seo = __webpack_require__(7018);
;// CONCATENATED MODULE: ./src/pages/home.jsx
const Gigi=props=>{function handleKeyPress(e){console.log(e);if(e.key==='g'){props.setShowGigi(!props.showGigi);}}return/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("input",{type:"text",className:hiddenInput,onKeyPress:e=>handleKeyPress(e)}));};const Home=()=>{const{0:showGigi,1:setShowGigi}=(0,index_js_.useState)(false);return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement(seo/* default */.Z,{title:"Home",description:"Sbrikki's Books - A Book Club for everyone"}),/*#__PURE__*/index_js_default().createElement("div",{className:home},/*#__PURE__*/index_js_default().createElement("div",{className:head},/*#__PURE__*/index_js_default().createElement("h1",null,/*#__PURE__*/index_js_default().createElement("strong",null,"Sbrikki's Books")," - Book Club")),showGigi?/*#__PURE__*/index_js_default().createElement(_404["default"],null):/*#__PURE__*/index_js_default().createElement(hero_hero,null),/*#__PURE__*/index_js_default().createElement("div",{className:description},/*#__PURE__*/index_js_default().createElement("p",null,/*#__PURE__*/index_js_default().createElement("strong",null,"Sbrikki's Books ")," is an apolitical book club for",/*#__PURE__*/index_js_default().createElement("strong",null," everyone "),".",/*#__PURE__*/index_js_default().createElement("br",null),"The main aim is the growth of",/*#__PURE__*/index_js_default().createElement("strong",null," every member "),"from a cultural point of view. We also drink.")),/*#__PURE__*/index_js_default().createElement(separator/* default */.Z,null),/*#__PURE__*/index_js_default().createElement(Gigi,{showGigi:showGigi,setShowGigi:setShowGigi}),/*#__PURE__*/index_js_default().createElement(bookClub,null),/*#__PURE__*/index_js_default().createElement(separator/* default */.Z,null)));};/* harmony default export */ const pages_home = (Home);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9336);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _home__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1318);
const IndexPage=()=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("main",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("title",null,"Home Page"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_home__WEBPACK_IMPORTED_MODULE_1__["default"],null));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (IndexPage);
