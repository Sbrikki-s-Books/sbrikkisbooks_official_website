...
var _react = _interopRequireDefault(__webpack_require__(9336));
...
var React = _interopRequireWildcard(__webpack_require__(9336));
...
var _react = __webpack_require__(9336);
...
exports.components={"component---src-pages-404-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-jsx */ 256).then(__webpack_require__.bind(__webpack_require__, 2726)),"component---src-pages-home-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-home-jsx */ 634).then(__webpack_require__.bind(__webpack_require__, 1318)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 7704)),"component---src-pages-king-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-king-jsx */ 31).then(__webpack_require__.bind(__webpack_require__, 6388)),"component---src-pages-spotify-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-spotify-jsx */ 825).then(__webpack_require__.bind(__webpack_require__, 7719)),"component---src-pages-stats-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-stats-jsx */ 363).then(__webpack_require__.bind(__webpack_require__, 3479))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-image',plugin:__webpack_require__(573),options:{"plugins":[]}},{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(9814),options:{"plugins":[]}},{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(6313),options:{"plugins":[],"output":"/sitemap","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(341),options:{"plugins":[],"icon":"src/assets/icon.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"4d42b60bbdbd4198c06a6d009c896d89"}},{name:'gatsby-plugin-mdx',plugin:__webpack_require__(6823),options:{"plugins":[],"extensions":[".mdx"],"defaultLayouts":{},"gatsbyRemarkPlugins":[],"lessBabel":false,"remarkPlugins":[],"rehypePlugins":[],"mediaTypes":["text/markdown","text/x-markdown"],"root":"/home/mike/Developing/sbrikkisbooks_official_website","commonmark":false}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
const trimmedPathname=stripPrefix(pathname,decodeURIComponent("/sbrikkisbooks"))// Remove any hashfragment
...
if(this.staticQueryDb[staticQueryHash]){const jsonPayload=this.staticQueryDb[staticQueryHash];return{staticQueryHash,jsonPayload};}return this.memoizedGet(`${"/sbrikkisbooks"}/page-data/sq/d/${staticQueryHash}.json`).then(req=>{const jsonPayload=JSON.parse(req.responseText);return{staticQueryHash,jsonPayload};}).catch(()=>{throw new Error(`We couldn't load "${"/sbrikkisbooks"}/page-data/sq/d/${staticQueryHash}.json"`);});})).then(staticQueryResults=>{const staticQueryResultsMap={};staticQueryResults.forEach(({staticQueryHash,jsonPayload})=>{staticQueryResultsMap[staticQueryHash]=jsonPayload;this.staticQueryDb[staticQueryHash]=jsonPayload;});return staticQueryResultsMap;});return Promise.all([componentChunkPromise,staticQueryBatchPromise]).then(([pageResources,staticQueryResults])=>{let payload;if(pageResources){payload=_objectSpread(_objectSpread({},pageResources),{},{staticQueryResults});finalResult.payload=payload;emitter.emit(`onPostLoadPageResources`,{page:payload,pageResources:payload});}this.pageDb.set(pagePath,finalResult);if(finalResult.error){return{error:finalResult.error,status:finalResult.status};}return payload;})// when static-query fail to load we throw a better error
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);var React=_interopRequireWildcard(__webpack_require__(9336));var _gatsby=__webpack_require__(2031);var _common=__webpack_require__(8108);var _getManifestPathname=_interopRequireDefault(__webpack_require__(1632));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(9336));var _gatsby=__webpack_require__(2031);var _path=__webpack_require__(1423);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
...
var MDXContext = /*#__PURE__*/index_js_default().createContext({});
var withMDXComponents = function withMDXComponents(Component) {
  return function (props) {
    var allComponents = useMDXComponents(props.components);
    return /*#__PURE__*/index_js_default().createElement(Component, _extends({}, props, {
      components: allComponents
    }));
  };
};
var useMDXComponents = function useMDXComponents(components) {
  var contextComponents = index_js_default().useContext(MDXContext);
...
var MDXProvider = function MDXProvider(props) {
  var allComponents = useMDXComponents(props.components);
  return /*#__PURE__*/index_js_default().createElement(MDXContext.Provider, {
    value: allComponents
  }, props.children);
};
...
var DEFAULTS = {
  ...
  wrapper: function wrapper(_ref) {
    ...
    return /*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment, {}, children);
  }
};
var MDXCreateElement = /*#__PURE__*/index_js_default().forwardRef(function (props, ref) {
  ...
  if (propComponents) {
    return /*#__PURE__*/index_js_default().createElement(Component, _objectSpread2(_objectSpread2({
      ref: ref
    }, etc), {}, {
  ...
  return /*#__PURE__*/index_js_default().createElement(Component, _objectSpread2({
    ref: ref
  }, etc));
});
...
const GatsbyMDXScopeContext=/*#__PURE__*/(0,index_js_.createContext)({});const useMDXScope=scope=>{const contextScope=useContext(GatsbyMDXScopeContext);return scope||contextScope;};const MDXScopeProvider=({__mdxScope,children})=>/*#__PURE__*/index_js_default().createElement(GatsbyMDXScopeContext.Provider,{value:__mdxScope},children);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9336);
...
var React = __webpack_require__(9336);
...
"use strict";
module.exports = require("/home/mike/Developing/sbrikkisbooks_official_website/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/home/mike/Developing/sbrikkisbooks_official_website/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/home/mike/Developing/sbrikkisbooks_official_website/node_modules/react/index.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-0c23715400b0809d1d21.js"],"app":["/app-c60b2ca44fae82a8d266.js"],"component---src-pages-404-jsx":["/component---src-pages-404-jsx-19dd36a884d367edb413.js"],"component---src-pages-home-jsx":[],"component---src-pages-index-js":["/component---src-pages-index-js-eb928f2f74e691dfcf88.js"],"component---src-pages-king-jsx":["/component---src-pages-king-jsx-22c3e14d8dd47a04f844.js"],"component---src-pages-spotify-jsx":["/component---src-pages-spotify-jsx-c823a76c570e0dec4de9.js"],"component---src-pages-stats-jsx":["/component---src-pages-stats-jsx-12a5f7e53cac6c27725c.js"]}');
...
/******/ 			return "" + {"31":"component---src-pages-king-jsx","256":"component---src-pages-404-jsx","363":"component---src-pages-stats-jsx","634":"component---src-pages-home-jsx","678":"component---src-pages-index-js","825":"component---src-pages-spotify-jsx"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		__webpack_require__.p = "/sbrikkisbooks/";
/******/ 	})();
/******/ 	
...
const scriptChunkMapping=`/*<![CDATA[*/window.___chunkMapping=${JSON.stringify(chunkMapping)};/*]]>*/`;postBodyComponents.push(/*#__PURE__*/React.createElement("script",{key:`chunk-mapping`,id:`gatsby-chunk-mapping`,dangerouslySetInnerHTML:{__html:scriptChunkMapping}}));let bodyScripts=[];if(chunkMapping[`polyfill`]){chunkMapping[`polyfill`].forEach(script=>{const scriptPath=`${"/sbrikkisbooks"}${script}`;bodyScripts.push(/*#__PURE__*/React.createElement("script",{key:scriptPath,src:scriptPath,noModule:true}));});}// Filter out prefetched bundles as adding them as a script tag
// would force high priority fetching.
bodyScripts=bodyScripts.concat(scripts.filter(s=>s.rel!==`prefetch`).map(s=>{const scriptPath=`${"/sbrikkisbooks"}/${JSON.stringify(s.name).slice(1,-1)}`;return/*#__PURE__*/React.createElement("script",{key:scriptPath,src:scriptPath,async:true});}));postBodyComponents.push(...bodyScripts);apiRunner(`onPreRenderHTML`,{getHeadComponents,replaceHeadComponents,getPreBodyComponents,replacePreBodyComponents,getPostBodyComponents,replacePostBodyComponents,pathname:pagePath,pathPrefix:"/sbrikkisbooks"});const html=`<!DOCTYPE html>${renderToStaticMarkup(/*#__PURE__*/React.createElement(Html,Object.assign({},bodyProps,{headComponents:headComponents,htmlAttributes:htmlAttributes,bodyAttributes:bodyAttributes,preBodyComponents:preBodyComponents,postBodyComponents:postBodyComponents,body:bodyHtml,path:pagePath})))}`;return{html,unsafeBuiltinsUsage:global.unsafeBuiltinUsage};}catch(e){e.unsafeBuiltinsUsage=global.unsafeBuiltinUsage;throw e;}}function getPageChunk({componentChunkName}){return asyncRequires.components[componentChunkName]();}
})();
