    ...
    return (
        <>
            <div className={styles.navDesktop}>
                ...
                <NavItem text="Contact us" path="/sbrikkisbooks/#contactUs" isHref={true} />
            </div>
            <div className={styles.navMobile}>
                ...
                <NavItem text="Contact us" path="/sbrikkisbooks/#contactUs" onClick={props.onClick} isHref={true} />
            </div>
        </>
    )
}
