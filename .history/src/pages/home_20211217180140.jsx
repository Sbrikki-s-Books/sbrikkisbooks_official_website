...
const Home = () => {
    ...
    return (
        <Layout>
            <Seo title={"Sbrikki's Books"} description={"Sbrikki's Books is an apolitical book club for everyone. The main aim is the growth of every member from a cultural point of view. We also drink."} />
