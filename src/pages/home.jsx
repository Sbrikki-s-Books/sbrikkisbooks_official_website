    ...
    <Layout>
      ...
      <div className={styles.home}>
        <div className={styles.head}>
          <h1>
            <strong>Sbrikki's Books</strong> - Book Club
          </h1>
        </div>
        <Hero />
        <Separator />
        ...
        <div className={styles.descrWrap}>
          ...
          <p className={styles.description}>
            The idea comes from the <strong>need</strong> of some of us to have a space in which{' '}
            <strong>to share</strong> the passion for culture and the growth of personality while attending an
            environment where it is difficult to have access to cultural resources.
            <br />
            <br />
            Thus was born Sbrikki's Books, <strong>our</strong> Book Club, in which we try, Socratically, to broaden our
            horizons of thought.
            <br />
            <br />
            The format is very simple: divided into work groups, we organize the weekly appointment on{' '}
            <strong>Thursday</strong> evening. We read a good book, drink wine, eat, other things and{' '}
